...
| **J** | Open **Wabun mode** settings screen (International / Wabun Katakana / Wabun Hiragana). |
| `;` | Increment value (WPM +1, freq +10 Hz, volume +10) — or select **On** in Radio Keying, **Normal** in Polarity, **cycle** in Wabun mode |
